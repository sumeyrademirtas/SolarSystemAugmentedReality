...
//        let mySphere = createSphere(radius: 0.1, content: "grass05.png", vector: SCNVector3(0, 0.2, -1))
    ...
    func createSphere(radius: CGFloat, content: String, vector:SCNVector3 ) -> SCNNode {
        ...
        boxMaterial.diffuse.contents = UIImage(named: content)
